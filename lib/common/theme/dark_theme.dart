...
class DarkTheme {
  // Акцент — чуть светлее для тёмного фона
  static const _accent = Color(0xFF4F8AC4);
  static const _accentHover = Color(0xFF3972AA);
  static const _accentPressed = Color(0xFF336699);
  static const _accentDisabled = Color(0x664F8AC4);

  static const _accentAdditional = Color(0xFF6FA3D4);
  ...
  static const _attentionPressed = Color(0xFFE07400);
  static const _attentionDisabled = Color(0x80FFA424);
  static const _error = Color(0xFFFF6B50);
  static const _errorHover = Color(0xFFF44725);
  static const _errorPressed = Color(0xFFE7320D);
  ...
  // Нейтральные — инвертированы
  static const _neutralLight = Color(0xFF6B7A8D);
  static const _neutralLightHover = Color(0xFF7A8A9C);
  static const _neutralLightPressed = Color(0xFF8A9AAC);
  static const _neutralLightDisabled = Color(0x33FFFFFF);
  static const _neutralDark = Color(0xFF9AA8B8);
  static const _neutralDarkHover = Color(0xFFAAB8C8);
  static const _neutralDarkPressed = Color(0xFFBAC8D8);
  static const _neutralDarkDisabled = Color(0x4DFFFFFF);
  static const _neutralBlack = Color(0xFFE0E6ED);
  static const _neutralBlackHover = Color(0xFFEAEFF5);
  static const _neutralBlackPressed = Color(0xFFF0F4F8);
  static const _neutralBlackDisabled = Color(0x66FFFFFF);
  ...
  static const _borderColor = Color(0xFF4A5568);
  static const _focusedBorderColor = Color(0xFF6B7A8D);
  ...
  late final _iconButtonThemeData = IconButtonThemeData(
    style: ButtonStyle(
      ...
      foregroundColor: const WidgetStatePropertyAll(_neutralBlack),
      overlayColor: WidgetStateProperty.resolveWith(
        (states) {
  ...
  late final _snackBarThemeData = SnackBarThemeData(
    ...
    elevation: 3,
    contentTextStyle: _textTheme.bodyMedium?.copyWith(color: _neutralBlack),
    ...
    style: _filledButtonTheme.style?.copyWith(
      ...
      shape: WidgetStateProperty.resolveWith(
        (states) {
          ...
          return StadiumBorder(side: BorderSide(color: borderColor));
        },
      ),
      overlayColor: WidgetStateProperty.resolveWith(
        (states) {
  ...
  late final _popupMenuThemeData = PopupMenuThemeData(
    ...
    surfaceTintColor: _backgroundElevated,
    elevation: 2,
    textStyle: _textTheme.bodyLarge?.copyWith(color: _neutralBlack),
  );
  ...
  late final _inputDecorationTheme = InputDecorationTheme(
    ...
    disabledBorder: OutlineInputBorder(
      borderSide: BorderSide(color: _neutralDarkDisabled.withValues(alpha: 0.3)),
    ),
    errorBorder: const OutlineInputBorder(
      borderSide: BorderSide(color: _error),
    ),
    focusedBorder: const OutlineInputBorder(
      borderSide: BorderSide(color: _focusedBorderColor, width: 3),
    ),
    focusedErrorBorder: const OutlineInputBorder(
      borderSide: BorderSide(color: _error, width: 3),
    ),
    outlineBorder: const BorderSide(color: _borderColor),
    ...
    prefixIconColor: WidgetStateColor.resolveWith(
      (states) {
        if (states.contains(WidgetState.disabled)) return _neutralBlackDisabled;
        return _neutralBlack;
      },
    ),
    suffixIconColor: WidgetStateColor.resolveWith(
      (states) {
        if (states.contains(WidgetState.disabled)) return _neutralBlackDisabled;
        if (states.contains(WidgetState.error)) return _error;
        return _neutralBlack;
      },
    ),
  ...
  final _buttonTheme = const ButtonThemeData(minWidth: 70, height: 40);
